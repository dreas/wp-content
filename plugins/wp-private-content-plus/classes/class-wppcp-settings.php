...
class WPPCP_Settings{
    ...
    public function admin_settings_menu(){
        ...
        add_submenu_page('wppcp-settings', __('User Profiles Made Easy', 'wppcp' ), __('User Profiles Made Easy', 'wppcp'),'manage_options','wppcp-upme-settings',array(&$this,'upme_settings'));
