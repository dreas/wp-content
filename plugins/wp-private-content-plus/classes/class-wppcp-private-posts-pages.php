...
class WPPCP_Private_Posts_Pages{
    ...
    public function add_post_restriction_box(){
        ...
        if(current_user_can('manage_options') || apply_filters('wppcp_restriction_setting_meta_box_visibility',false,array() ) ){
        
            foreach ( $post_types as $post_type ) {
                if(!in_array($post_type, $skipped_types)){
                    add_meta_box(
                        'wppcp-post-restrictions',
                        __( 'WP Private Content Pro - Restriction Settings', 'wppcp' ),
